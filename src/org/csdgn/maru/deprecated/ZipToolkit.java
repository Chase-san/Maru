...
public class ZipToolkit {
	public static final void append(ZipOutputStream zip, String name, File input)
			throws IOException {
		append(zip, name, new FileInputStream(input));
	}

	public static final void append(ZipOutputStream zip, String name,
	...
	public static final ZipOutputStream getAsWritable(File file)
			throws IOException {
		if (!file.exists()) {
			// new empty zip file :)
